...
/*   Updated: 2025/01/16 14:43:33 by tkitago          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

/// @brief 2つのパス文字列を結合して、1つの完全なパスを生成
/// @param base ベースとなるパス文字列(ディレクトリパスやURLのベース部分)
/// @param path 追加するパス文字列(ファイル名やサブディレクトリのパス)
/// @return 完全なパス
char	*ft_joinpath(char *base, char *add_path)
{
	...
	// base の最後の文字が'/'かどうかをチェックし、結果を separate に格納
